...
Run the following command in the terminal
 ...
 curl -v -GET http://crud-oidc-user1-keycloak.apps.cluster-gq8kd.gq8kd.sandbox2843.opentlc.com/books
...
We will create a new realm by exporing the realm config file. To do that download the Quarkus-realm config file to your own machine.

Login to your SSO instance again; https://sso-user1-keycloak.apps.cluster-gq8kd.gq8kd.sandbox2843.opentlc.com
...
Copy the above properties in the application.properties file. <1> is the authenticatin url that our Quarkus application will use to establish authentication. <2> name of our client. should be similar to the one in our realm config <3> our confidential secret to authenticate the backend-service.
